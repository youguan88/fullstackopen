...
const user = {
  token:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImVtaWx5IiwiaWQiOiI2NTQyNWFkOWMxYzM2MWM3ZGJlYjA2OGQiLCJpYXQiOjE2OTk0MDYyMDl9.o7Q7hn5tAfmUz4FWcTMHsu4X7h-7km9pXSmjHsANrp8',
  username: 'emily',
  name: 'emily watsons',
  id: '65425ad9c1c361c7dbeb068d'
}
...
test('clicking the button twice calls event handler twice', async () => {
  ...
  render(<ToggleButton action={mockHandler} label="view" />)
  const ue = userEvent.setup()
  const button = screen.getByText('view')
  await ue.click(button)
  await ue.click(button)
